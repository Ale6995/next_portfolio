...
const QuickHireForm = forwardRef((_, ref) => {
    ...
    const handleSubmit = async () => {
        if (!formData.name || !formData.companyName || !formData.phone || !formData.address || !formData.position || !formData.salaryMin || !formData.salaryMax || !formData.requirementDuration || !formData.startDate) {
...
QuickHireForm.displayName = "QuickHireForm";
